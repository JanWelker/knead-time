...
const de: Messages = {
	...
	nav: {
		plan: 'Dein Plan',
		library: 'Rezepte',
		adjust: 'Rezept bearbeiten',
		menu: 'Menü',
		back: 'Zurück',
		next: 'Weiter',
		see_plan: 'Zum Plan',
		skip: 'Direkt zum Plan',
		restart: 'Schritt für Schritt planen',
...
const nl: Messages = {
	...
	form: {
		...
		info_fit_body:
			'Begint op 100 punten; één ster per 20. Er gaan punten af wanneer het schema moest buigen (koelfase of voordeeg buiten de natuurlijke duur, een stap vast in het nachtvenster, een onhaalbaar venster) en wanneer invoer buiten de hedendaagse Napolitaanse banden valt: 60–80% hydratatie, 2–3,5% zout, bolletjes van 200–320 g, kamer 14–30 °C, koelkast 2–8 °C, opgeloste gist 0,05–1,5% in verse-gist-termen (gedroogde gist en desem worden eerst omgerekend; de gistwaarschuwingen gaan af op dezelfde band) — en wanneer het venster buiten valt wat het gekozen meel verdraagt. Elke aftrek is gemaximeerd, dus één wilde invoerwaarde kan de waardering niet op nul zetten.',
