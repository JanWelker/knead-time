...
<details bind:this={detailsRef} class="group relative inline-block">
	<summary
		class="hover:text-tomato-600 dark:hover:text-tomato-300 text-ink-soft inline-flex cursor-pointer list-none items-center gap-1.5 py-0.5 text-sm font-medium select-none"
	...
	<div
		class="border-rule absolute z-20 mt-2 max-w-sm rounded-2xl border bg-white p-3 text-sm shadow-lg"
	>
