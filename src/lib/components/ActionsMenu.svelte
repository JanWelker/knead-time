...
<details bind:this={ref} bind:open>
	<summary
		class="btn-ink flex cursor-pointer list-none items-center gap-2 select-none"
		aria-haspopup="menu"
	...
	<div
		role="menu"
		class="border-rule-strong bg-paper absolute right-0 z-20 mt-2 min-w-[14rem] overflow-hidden border py-1 shadow-lg"
	>
